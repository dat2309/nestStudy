...
export class UserController {
  ...
  getUsers(): ResponseData<User[]> {
    try {
      return new ResponseData<User[]>(this.userService.findAll(), HttpStatus.OK, HttpMessage.OK);
    } catch (error) {
      return new ResponseData<User[]>("Failed to create user" ,HttpStatus.INTERNAL_SERVER_ERROR, HttpMessage.INTERNAL_SERVER_ERROR);
    }
