...
export class UserController {
  ...
  @Post()
  create(@Body() createUserDto: CreateUserDto): Promise<ResponseData<User | string>> {
    try {
      return new ResponseData<User>(this.userService.create(createUserDto), HttpStatus.OK, HttpMessage.OK);
    } catch (error) {
