...
export class UserService {
  ...
  async create(createUserDto: CreateUserDto): Promise<User> {
    ...
    const accountData = {
      accountName: createUserDto.accountName, // Assuming accountName is part of userData
      password: createUserDto.password,       // Assuming password is part of userData
      role: createUserDto.role,               // Assuming role is part of userData
