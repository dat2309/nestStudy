...
export class UserService {
  ...
  async create(createUserDto: CreateUserDto): Promise<User> {
    ...
    const accountData = {
      accountName: userData.accountName, // Assuming accountName is part of userData
      password: userData.password,       // Assuming password is part of userData
      role: userData.role,               // Assuming role is part of userData
