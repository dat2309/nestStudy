...
export const getUsers = async (searchQuery?: string, sortBy?: string): Promise<BaseResponse<User[]>> => {
    try {
        const response = await axiosInstance.get('/user', {
            headers: {
                Athorization: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2NvdW50TmFtZSI6IkpvaG4gRG9lIiwic3ViIjoxLCJ1c2VySWQiOjEsImlhdCI6MTcyMzE3MTI5NiwiZXhwIjoxNzIzMTc0ODk2fQ.hK_PM8NLecl61kXBnzgM3lk1k6v6sSbAgHcH8EYWhYs"
            },
            params: {
