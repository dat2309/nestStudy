        ...
        <div className="p-4">
            ...
            <div className="mb-4">
                ...
                <div className="mt-4 space-x-2">
                    <button onClick={() => handleSort('-1')} className="btn">Sort</button>
                    <button onClick={() => handleSort('0')} className="btn">ID</button>
                    <button onClick={() => handleSort('1')} className="btn">Name</button>
                    <button onClick={() => handleSort('2')} className="btn">Age</button>
                    <button onClick={() => handleSort('3')} className="btn">Phone</button>
                </div>
            </div>
            <ul>
                {users.map(user => (
