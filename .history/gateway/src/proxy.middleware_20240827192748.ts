            ...
            const proxyOptions: Options = {
                ...
                on: {
                    proxyReq: (proxyReq, req, res) => {
                        ...
                        proxyReq.setHeader('Custom-Header', 'YourHeaderValue'); // Example custom header
                    ...
                    error: (err, req, res) => {
                        ...
                        // This is necessary because the proxy middleware
                        // does not automatically pass through the Content-Type
